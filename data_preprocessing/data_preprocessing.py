...
class Preprocessing:
    ...
    def __read_data(self):
        ecg_test = pd.read_csv(self.test_path, header=None)
        ecg_train = pd.read_csv(self.test_path, header=None)

        return ecg_train, ecg_test

    def vis(self):
        ecg_train, ecg_test = self.__read_data()
